<?php
//Default Configuration. CONFIG_THIS "lang": "en" and "en" are available.
...
// Generate secure password hash - /docs/pwd.html
$auth_users = readUsers();
...
$GLOBALS['online_viewer'] = 'microsoft';
            ...
            <div class="container h-100">
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="brand">
                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="121px" viewBox="0 0 512 512" aria-label="File Manager">
								<g>
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    ...
                                    <div class="form-group">
										...
										<a href="account.php?web=signup" class="btn btn-primary btn-block" role="button">
                                            <?php echo lng('SignUp'); ?>
                                        </a>
                                    </div>
                                </form>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="/" target="_blank" class="text-muted" >Vaibhav & Kartik</a>
							<a href="/" target="_blank" class="text-muted" ></a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
						<p><h3><a href="/" target="_blank" class="app-v-title" style="margin-bottom:0"><b>Cloud Drive</b></a></h3></p>
                        <p><a href="/" target="_blank" class="app-v-title" style="font-size:1.3em;margin-top:0">File Manager</a></p>
                        <p>Mail Us: <a href="mailto:jlucky454@gmail.com">jlucky454@gmail.com</a> <a href="mailto:vaibhav.jain@sakec.ac.in">vaibhav.jain@sakec.ac.in</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
if (isset($_GET['view'])) {
    ...
    $file_url =  fm_convert_win((FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $file);
    $file_path = $path . '/' . $file;
    ...
    <div class="row">
        <div class="col-12">
            <?php if(!$quickView) { ?>
                ...
                <p class="break-word">
					<?php $zbx_fileextlink = "https://".$_SERVER['HTTP_HOST'].str_replace($_SERVER['DOCUMENT_ROOT'],"",$file_path); ?>
					Link URI: <a href="<?php echo fm_enc($zbx_fileextlink) ?>"><?php echo fm_enc($zbx_fileextlink) ?></a><br>
                    ...
                    if (($is_zip || $is_gzip) && $filenames !== false) {
                        ...
                        ?>
                        File count: <?php echo $total_files ?><br>
                        Total size: <?php echo fm_get_filesize($total_uncomp) ?><br>
                        Archived size: <?php echo fm_get_filesize($total_comp) ?><br>
                        Ratio: <?php echo round(($total_comp / $total_uncomp) * 100) ?>%<br>
                        <?php
                    }
                    // Image info
                    if ($is_image) {
                        $image_size = getimagesize($file_path);
                        echo 'Image size: ' . (isset($image_size[0]) ? $image_size[0] : '0') . ' x ' . (isset($image_size[1]) ? $image_size[1] : '0') . '<br>';
                    }
                    // Text info
                    if ($is_text) {
                ...
                <ul class="navbar-nav mr-auto float-right">
                    ...
                    <li class="nav-item avatar dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink-5">
							...
							<a title="<?php echo lng('DeleteAccount') ?>" class="dropdown-item nav-link" href="account.php?web=delete"><i class="fa fa-ban" aria-hidden="true"></i> <?php echo lng('DeleteAccount'); ?></a>
                        </div>
                    </li>
                    <?php endif; ?>
                </ul>
...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.staticfile.org/ekko-lightbox/5.3.0/ekko-lightbox.css" />
    <?php if (FM_USE_HIGHLIGHTJS): ?>
    <link rel="stylesheet" href="https://cdn.staticfile.org/highlight.js/9.15.10/styles/<?php echo FM_HIGHLIGHTJS_STYLE ?>.min.css">
    <?php endif; ?>
    <style>
        body {
            font-size: 14px;
...
<script>
    ...
    function show_new_pwd() { $(".js-new-pwd").toggleClass('hidden'); window.open("/docs/pwd.html", '_blank'); }
    //Save Settings
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Cloud Drive';      $tr['en']['AppTitle']           = 'File Manager';
